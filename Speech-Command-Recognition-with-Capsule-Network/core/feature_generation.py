...
if __name__ == "__main__":
    ...
    parser.add_argument('--audio_path', default='/DATA/jsbae/Google_Speech_Command', type=str)
    ...
    parser.add_argument('--noise_name', default='clean', 
        ...
        type=str)
    parser.add_argument('--noiseSNR', default=None, type=int)
    ...
    ########### For Noise SNR test ###########
        audio_path = audio_path + 'SNR' + str(args.noiseSNR)
        ...
        for i in range(len(noise)):
            ...
            print(noise[i])
            if os.path.exists(os.path.join(audio_path, noise[i])):
